...
Die Szenarienbibliothek ist Ihre Möglichkeit für Feedback! Wenn Sie sich nicht sicher sind, ob Sie ein Szenario richtig verstanden und korrekt ausgeführt haben, dann bitten Sie Frau Metz (am besten während des Unterrichts), gemeinsam mit Ihnen das entsprechende Video anzuschauen und zu besprechen.
...
Wenn bei einem Szenario z.B. steht «an Frau Metz senden», dann senden Sie es beim Üben bitte **an eine:n Kolleg:in**. Erst bei der Probe müssen Sie es an Frau Metz senden.
:::
...
### Szenario 12
- Teams öffnen und eine Nachricht mit einer kurzen Begrüssung, dem Text «Ich übe die BYOD-Szenarien.» und einem kurzen Gruss an Frau Metz schicken.

### Szenario 13
- Den Ordner `programme` komprimieren
- Die komprimierte Datei zu `programme_byod.zip` umbenennen
- Die komprimierte Datei per Mail an Frau Metz schicken (dabei einen passenden Betreff, eine Begrüssung und einen kurzen Gruss nicht vergessen!)
...
### Szenario 22
- Öffnen Sie Teams und starten Sie eine Video-Konferenz mit Frau Metz
...
- Senden Sie den Link per Teams an Frau Metz

### Szenario 24
- Öffnen Sie die GBSL-Webseite (die Adresse lautet `gbsl.ch`), ohne dabei eine Suchmaschine (z.B. Google, Bing, Ecosia, …) zu verwenden

### Szenario 25
- Laden Sie [diese Datei](https://erzbe-my.sharepoint.com/:t:/g/personal/friederike_metz_gbsl_ch/EcWs-7eDwkNLp2f2lts1wRIB3tp9Qy5lJIIXPQ1B5j2Z_Q?e=DWoKZl) herunter
