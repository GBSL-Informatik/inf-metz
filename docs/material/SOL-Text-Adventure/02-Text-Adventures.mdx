...
Komplexere Programme wie Text Adventures lassen sich nicht gut auf unserer Webseite ausführen. Laden Sie das Programm herunter (:mdi[download]), öffnen Sie es mit VSCode und führen Sie es dort aus.
